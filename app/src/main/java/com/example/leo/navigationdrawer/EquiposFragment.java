...
public class EquiposFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        añadir =(Button) view.findViewById(R.id.button);
        equipo=(EditText) view.findViewById(R.id.editText);
        ...
        añadir.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                try {
                    dbAyuda.abrir();
                    long result = dbAyuda.registrarEquipo(equipo.getText().toString());
                    equipo.setText("");
                    if(result>0){
                        Toast.makeText(getActivity().getBaseContext(),"Equipo insertado con éxito", Toast.LENGTH_LONG).show();
                    }
                    dbAyuda.cerrar();
                } catch (Exception e) {
